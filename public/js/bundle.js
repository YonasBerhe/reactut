...
//imports react as a module similar to var react = require("react");
'use strict';
...
_reactRouter2['default'].rn(_routes2['default'], _reactRouter2['default'].HistoryLocation, function (Handler) {
	_react2['default'].render(_react2['default'].createElement(Handler, null), document.getElementId('app'));
});
